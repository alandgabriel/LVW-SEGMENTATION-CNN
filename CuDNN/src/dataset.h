...
{
    public:
    Dataset() : dataset_dir_("./") {}
    Dataset(std::string dataset_dir) : dataset_dir_(dataset_dir) {}
    ~Dataset();
    ...
    std::string train_label_file_   = "train-targets-idx3-ubyte";
    std::string test_dataset_file_  = "test-images-idx3-ubyte";
    std::string test_label_file_    = "test-targets-idx3-ubyte";
#elif _WIN32
    std::string train_dataset_file_ = "train-images.idx3-ubyte";
